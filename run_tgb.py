...
# python tools/demo_track.py --demo image --path D:/CourtAthena/02_Datasets/TGB/dataset/seq01/img1 -f exps/example/mot/yolox_x_mix_det.py -c pretrained/yolox_x_sports_mix.pth.tar --seq seq01 --det_path D:/CourtAthena/02_Datasets/TGB/dataset/seq01/gt/gt.txt
for seq in seq_list:
    print(f"Processing sequence: {seq}")
    img_path = os.path.join(tgb_test, seq, "img1")
    gt_path = os.path.join(tgb_test, seq, "gt", "gt.txt")
